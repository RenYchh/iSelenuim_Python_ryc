...
class ISelenium(unittest.TestCase):
    ...
    def _test_baidu(self, search_keyword, testcase_name):
        ...
        time.sleep(5)
        # print("1111111111111111111111",self.driver.title)
        # print("222222222222222222222",f'百度一下')
        assert f'百度一下' in self.driver.title

        #该写法已经不支持了，需要换成下面的find_element('name', "wd")写法
        # elem = self.driver.find_element_by_name("wd")
        elem = self.driver.find_element('name', "wd")
